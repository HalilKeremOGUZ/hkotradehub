...
export default async function RootLayout({children}:{children:React.ReactNode}){
 ...
 const structuredData = [
  {"@context":"https://schema.org","@type":"Organization",name:"HKO Trade Hub",url:SITE_URL,logo:`${SITE_URL}/hko-trade-hub-logo.png`,description:"Global B2B trade platform specialized in Türkiye–Chile trade."},
