...
export default async function RootLayout({children}:{children:React.ReactNode}){
 ...
 const structuredData = [
  {"@context":"https://schema.org","@type":"Organization",name:"HKO Trade Hub",alternateName:["HKOTradeHub","hkotradehub"],url:SITE_URL,logo:`${SITE_URL}/hko-trade-hub-logo.png`,description:"Global B2B trade platform specialized in Turkey–Chile trade."},
  {"@context":"https://schema.org","@type":"WebSite",name:"HKO Trade Hub",alternateName:["HKOTradeHub","hkotradehub"],url:SITE_URL,inLanguage:["tr","en","es"],publisher:{"@type":"Organization",name:"HKO Trade Hub",url:SITE_URL}},
 ];
