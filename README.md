...
## v1.1 Premium Homepage

This package includes the v1.1 homepage redesign:
- Global positioning with Türkiye–Chile specialization
- Premium responsive hero and navigation
- Industry, service, trade route, process and trust sections
- Turkish, English and Spanish homepage copy
- Updated SEO metadata
- Refined product cards and footer
